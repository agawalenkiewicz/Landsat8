...
filename = Landsat_ncfiles.torness
...
for i, element in enumerate(filename):
	element_path = os.path.join('/glusterfs/surft/users/mp877190/data/datastore/EE/LANDSAT_8_C1/torness_checked', element)
...
for element in filename:
	...
	aga_outflow_b10.append(nc_file.variables['BT_band10'][200,196])
	aga_outflow_b11.append(nc_file.variables['BT_band11'][200,196])
...
with open('torness_inflow_temp_b10', 'wb') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(inflow_temp_b10)
with open('torness_inflow_temp_b11', 'wb') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(inflow_temp_b11)
with open('torness_outflow_temp_b10', 'wb') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(outflow_temp_b10)
with open('torness_outflow_temp_b11', 'wb') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(outflow_temp_b11)

with open('torness_outflow_aga_temp_b10', 'wb') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(aga_outflow_b10)
with open('torness_outflow_aga_temp_b11', 'wb') as myfile:
    wr = csv.writer(myfile)
